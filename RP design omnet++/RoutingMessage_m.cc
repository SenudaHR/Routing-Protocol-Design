...
RoutingMessage::RoutingMessage(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}

RoutingMessage::RoutingMessage(const RoutingMessage& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
const char * RoutingMessage::getOrigin() const
{
    return this->origin.c_str();
}

void RoutingMessage::setOrigin(const char * origin)
{
    this->origin = origin;
}

int RoutingMessage::getSeq() const
{
    return this->seq;
}

void RoutingMessage::setSeq(int seq)
{
    this->seq = seq;
}

const char * RoutingMessage::getType() const
{
    return this->type.c_str();
}

void RoutingMessage::setType(const char * type)
{
    this->type = type;
}

const char * RoutingMessage::getPayload() const
{
    return this->payload.c_str();
}

void RoutingMessage::setPayload(const char * payload)
{
    this->payload = payload;
}

const char * RoutingMessage::getSignature() const
{
    return this->signature.c_str();
}

void RoutingMessage::setSignature(const char * signature)
{
...
RoutingMessageDescriptor::RoutingMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(RoutingMessage)), "omnetpp::cPacket")
{
...
int RoutingMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    RoutingMessage *pp = omnetpp::fromAnyPtr<RoutingMessage>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void RoutingMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    RoutingMessage *pp = omnetpp::fromAnyPtr<RoutingMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'RoutingMessage'", field);
    }
}

const char *RoutingMessageDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string RoutingMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void RoutingMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'RoutingMessage'", field);
    }
}

omnetpp::cValue RoutingMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'RoutingMessage' as cValue -- field index out of range?", field);
    }
}

void RoutingMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::any_ptr RoutingMessageDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void RoutingMessageDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
